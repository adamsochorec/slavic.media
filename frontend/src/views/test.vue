<template>
  ...
  <p class="reveal">
    ...
    moments – from live concerts in the iconic Pitstop venue to workshops where
    local artists shared their skills, like leather crafting, ceramics, or
  ...
  <p class="reveal">
    ...
    campaigns, and attracting more artists to this unique community. For us, it
  ...
  <p class="reveal">
    ...
    about bringing unique stories to life through visual media, and this
