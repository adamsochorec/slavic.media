...
Helios 44 is well-known for the wonderfully :VideoSeek{id="Roug9ph4H5A" seconds="2" autoscroll=true}[imperfect bokeh] it produces. To increase the volume of these bubbles, working with vegetation is great; trees in direct sunlight can create surreal yet sharp images. With certain appeture and light conditions, you might get almost an anamorphic looking bokeh, just line in the example bellow.
...
This already shallow depth of field can be easily amplified through a set of extension rings mounted between the camera body and the lens. In combination with the Flektogon 35mm—which can start producing sharp images from as close as 2 cm by default—we are dealing with a very fun :VideoSeek{id="Roug9ph4H5A" seconds="97" autoscroll=true}[macro setup].
