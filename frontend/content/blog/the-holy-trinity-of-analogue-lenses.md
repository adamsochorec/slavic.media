---
title: The Holy Trinity of Analogue Lenses
thumbnail: the-holy-trinity-of-analogue-lenses
icon: camera
length: 10
slug: the-holy-trinity-of-analogue-lenses
keywords:
  - Analogue lens
  - Vintage lens
  - Flektogon
...
> In photography, bokeh is the aesthetic quality of the blur produced in out-of-focus parts of an image, whether foreground or background or both. It is created by using a wide aperture lens. :br -[Wikipedia](https://en.wikipedia.org/wiki/Bokeh)
...
This already shallow depth of field can be easily amplified through a set of extension rings mounted between the camera body and the lens. In combination with the Flektogon 35mm—which can start producing sharp images from as close as 2 cm by default—we are dealing with a very fun macro setup, as can be seen in the :VideoSeek{id="Roug9ph4H5A" seconds="97"}[video].
...
As you can :VideoSeek{id="yz9db5a_U3A" seconds="6"}[see in the video], the Helios 44 is well-known for the wonderfully *imperfect* bokeh it produces. To increase the volume of these bubbles, working with vegetation is great; trees in direct sunlight can create surreal yet sharp images. With certain appeture and light conditions, you might get almost an anamorphic looking bokeh, just line in the example bellow.
...
---
id: yz9db5a_U3A
title: Helios 44-2 58mm f/2 with Lumix GH6
controls: false
loop: true
autoplay: true
---
...
![Flektogon 35mm f/2.4](https://cdn.slavic.media/img/2021-04-14-00608/4K "Portrait captured on Flektogon 35mm f/2.4")
...
However, there is a certain quirk of the Orestor that we shall call a feature: its :VideoSeek{id="8m18ghC49XU" seconds="6"}[focus imperfection] when shooting wide open. Finding the right focus can be tricky. Even when you hit the focus range perfectly, it might feel like you just missed it due to the very soft aura right on the borderline between the focused object and the background.


::YoutubeVideo
---
id: 8m18ghC49XU
title: Orestor 100mm f/2.8 with Lumix GH6
controls: false
loop: true
autoplay: true
---
